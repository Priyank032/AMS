                ...
                <ul>
                    <li>
                        <div>
                            ...
                            <Link to='/Admin' className='d-inline'>Dashboard </Link>
                        </div>
                    </li>
                    <li>
                        <div>
                            <FaChalkboardTeacher style={{ fontSize: "24px" }} />
                            <Link to='/Admin/All_Users' className='d-inline'>All Schools</Link>
                        </div>
                    </li>
                    <li>
                        <div>
                            <FaChalkboardTeacher style={{ fontSize: "24px" }} />
                            <Link to='/Admin/Add_User' className='d-inline'>Add school </Link>
                        </div>
                    </li>
                </ul>
