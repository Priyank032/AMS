            ...
            <div className='Sidebar_for_all_panel' id="mySideBar">
                <ul>
                    ...
                    <li>
                        <div>
                            <FaChalkboardTeacher style={{ fontSize: "24px" }} />
                            <Link to='/Student/Show_Attendence' className='d-inline'>ShowAttendence</Link>
                        </div>
                    </li>
                    <li>
                        <div>
                            <FaChalkboardTeacher style={{ fontSize: "24px" }} />
                            <Link to='/Student/Show_Marks' className='d-inline'>Show Marks </Link>
                        </div>
                    </li>
                    <li>
                        <div>
                            <FaChalkboardTeacher style={{ fontSize: "24px" }} />
                            <Link to='/Student/Learning' className='d-inline'>Learning Panel </Link>
                        </div>
                    </li>
                </ul>
